...
import { GetModulesStatus, GetModuleStatusAnswer, GetModuleStatusAnswerWithMetadata } from "./messages";
...
abstract class MPSServerClientGen extends BaseWSClient {
    ...
    async getModulesStatus(): Promise<GetModuleStatusAnswer> {
        const _params : GetModulesStatus = {};
        const res = await this.client.call('GetModulesStatus', _params) as GetModuleStatusAnswerWithMetadata;
